...
<head>
    ...
    <link rel="stylesheet" href="css/meetease.css">
...
<div style = "padding-right: 500px; padding-top: 80px; position: fixed;"> 
    <div style= "padding: 100px; border: 10px solid black; border-left: 0px; border-radius: 50px">
        ...
        <div>
            <p style= "font-size: 18px;">Make Meetings, Join Meetings and Never Miss Out on a Meeting</p>
...
<!--image at the right-->
<div style="position: fixed; top: 40px; left: 1090px; padding-top: 150px;  ">
    <img src="Images/Black White Simple People Bookmark.jpg" style="width: 300px; height:auto;border: 2px solid black; border-radius: 50px;box-shadow: 0px 5px 10px black; border-left: 0px; ">
</div>
